package cn.com.zg.springmqtt.client.service;

import cn.com.zg.springmqtt.client.callback.PushCallback;
...
//    public static final String TOPIC_RECEIVE = "test_topic2";
//    public static final String TOPIC_SEND = "test_topic1";
    ...
    public String start() {
        ...
        try {
            ...
            MqttTopic topic = client.getTopic("client-close");
            //setWill方法，如果项目中需要知道客户端是否掉线可以调用该方法。设置最终端口的通知消息
            options.setWill(topic, "client2-close".getBytes(), 2, false);
